...
class AugmenterRegistry:
    ...
    def __init__(self) -> None:
        self._augmenters: Dict[str, Type[Augmenter]] = {}

    def register(self, name: str, augmenter_cls: Type[Augmenter]) -> None:
        if not name:
        ...
        self._augmenters[name] = augmenter_cls
